...
//     this.target.height = height; //Get context 

//     this.context = this.target.getContext("2d"); //Circle 
...
//   build() {
//     let gradient = this.context.createLinearGradient(0, 0, this.width, 0); //Color Stops
...
//     gradient.addColorStop(1, "rgb(255, 0, 0)"); //Fill it

//     this.context.fillStyle = gradient;
//     this.context.fillRect(0, 0, this.width, this.height); //Apply black and white 
...
//     this.context.fillStyle = gradient;
//     this.context.fillRect(0, 0, this.width, this.height); //Circle 
...
// let picker = new Picker(document.getElementById("color-picker"), 250, 220); //Draw 
